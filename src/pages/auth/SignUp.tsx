...
const SignUp = () => {
  ...
  return (
    <AuthLayout headline="START FREE." sub="ทดลองใช้ KIVORA ได้จริงก่อนจ่าย — 3 โปรเจกต์ 30 AI Pages 10 AI Images" seo={{ title: "สมัครใช้ฟรี | KIVORA สร้าง E-Book ด้วย AI", description: "สมัครใช้ KIVORA ฟรี ไม่ต้องใช้บัตรเครดิต เริ่มสร้างหนังสือ e-book และสไลด์ด้วย AI ได้ทันที", path: "/auth/sign-up" }}>
      {sent ? (
